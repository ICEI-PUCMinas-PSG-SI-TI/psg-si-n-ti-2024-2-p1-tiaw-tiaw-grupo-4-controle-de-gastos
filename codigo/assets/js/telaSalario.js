...
async function atualizarSalario(salario, idUsuario) {
    const options = {
        method: "PUT",
        headers: {
...
async function salvarSalario(usuarioJson) {
    ...
    if (!titulo || !valor || !data || !recorrencia) {
        ...
        salario.push(novoSalario);
        await atualizarSalario(salario, usuarioJson.id);    
    }    
